  ...
  offers: [
    {
      ...
      price: "0",
      priceCurrency: "EUR",
      description: "Free forever — 5 credits/month",
    },
    {
      "@type": "Offer",
      name: "Pro",
      price: "39",
      priceCurrency: "EUR",
      description: "100 credits/month, all scrapers, voice mining",
    },
    {
      "@type": "Offer",
      name: "Operator",
      price: "99",
      priceCurrency: "EUR",
      description: "350 credits/month, API access, 3 seats, priority queue",
    },
    {
      "@type": "Offer",
      name: "Agency",
      price: "249",
      priceCurrency: "EUR",
      description: "1,200 credits/month, white-label, 10 seats, Slack support",
    },
  ],
  aggregateRating: {
